...
size", "mlp_epochs", "hits1", "hits5", "hits10", "mrr", "fhits1", "fhits5", "fhits10", "fmrr"]

        df_cat.columns = ["num_walks", "walk_length", "alpha", "w2v_epochs", "window_size", "embedding_size\
", "mlp_epochs", "hits1", "hits5", "hits10", "mrr", "fhits1", "fhits5", "fhits10", "fmrr"]
...
", "hits1", "hits5", "hits10", "mrr", "fhits1", "fhits5", "fhits10", "fmrr"]
    ...
    new_df = best_owl2vec.append(best_cat)

    new_df.to_csv(root + "best_results", index=False)
